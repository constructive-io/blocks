...
// The Suspense wrapper preserves the source's lazy-loaded MapLibre MapPicker. Escape is
...
export function GeometryEditorDom({ value, fieldMeta, onCommit, onCancel }: EditorProps) {
  const expectedType = resolveExpectedGeometryType(fieldMeta?.type?.subtype);
  return (
