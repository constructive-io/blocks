...
import type { GeneratedField } from '@/blocks/schema/schema-builder-core/components/policies/policy-types';
									...
									<>
										...
										<div className='flex items-center gap-0.5'>
											...
											<button
												...
												aria-label={`Save ${displayName} field name`}
												className='hover:bg-muted text-muted-foreground hover:text-foreground grid size-10 place-items-center rounded-lg
													transition-[background-color,color,scale] duration-(--duration-moderate) ease-out motion-safe:active:scale-[0.96]'
													>
											...
											<button
												...
												aria-label='Cancel field name edit'
												className='hover:bg-muted text-muted-foreground hover:text-foreground grid size-10 place-items-center rounded-lg
													transition-[background-color,color,scale] duration-(--duration-moderate) ease-out motion-safe:active:scale-[0.96]'
													>
											...
											<button
												...
												aria-label={`Reset ${displayName} field name`}
												className='hover:bg-muted text-muted-foreground hover:text-foreground grid size-10 place-items-center rounded-lg
													transition-[background-color,color,scale] duration-(--duration-moderate) ease-out motion-safe:active:scale-[0.96]'
													>
										...
										{canEdit && (
											<Tooltip>
												<TooltipTrigger asChild>
													...
													disabled={disabled}
													aria-label={`Edit ${displayName} field name`}
														className='hover:bg-muted text-muted-foreground hover:text-foreground grid size-10 place-items-center rounded-lg opacity-60
															transition-[background-color,color,opacity,scale] duration-(--duration-moderate) ease-out hover:opacity-100 motion-safe:active:scale-[0.96]
