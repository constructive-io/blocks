// Shared, realistic fixtures for Storage stories. Static data only.

import type { StorageBucket, StorageObject, UploadItem } from '../types';
...
export const documentObject = objects[1];
