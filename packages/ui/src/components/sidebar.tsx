	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					`fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-transform duration-200 ease-out
	...
	return (
		<Comp
			...
			className={cn(
				...
				outline-hidden transition-opacity duration-150 ease-out focus-visible:ring-2 motion-reduce:transition-none [&>svg]:size-4
				[&>svg]:shrink-0`,
...
function SidebarMenuSkeleton({
	...
	// Stable variation between 50 and 89%. React's ID is identical across SSR
	// and hydration, unlike ambient randomness.
