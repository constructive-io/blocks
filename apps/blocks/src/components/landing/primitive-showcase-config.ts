...
export const HOME_SHOWCASE_DEMOS = {
  accordion: getUiDemo('accordion', 'AccordionFaqDemo'),
  ...
  'button-group': getUiDemo('button-group', 'ButtonGroupSplitDemo'),
  ...
  item: getUiDemo('item', 'ItemGroupDemo'),
  kbd: getUiDemo('kbd', 'KbdShortcutsDemo'),
  ...
  slider: getUiDemo('slider', 'SliderFieldDemo'),
  spinner: getUiDemo('spinner', 'SpinnerInlineDemo'),
  ...
  toggle: getUiDemo('toggle', 'ToggleToolbarDemo'),
  'toggle-group': getUiDemo('toggle-group', 'BasicToggleGroupDemo'),
