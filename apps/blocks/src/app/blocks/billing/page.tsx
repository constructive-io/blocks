  ...
  return (
    <article className="registry-page">
      <header className="mb-8 max-w-2xl">
        ...
        <h1 className="mt-2 text-balance text-[22px] font-semibold tracking-tight sm:text-[1.75rem]">Billing</h1>
        ...
        <p className="mt-3 font-mono text-xs text-muted-foreground tabular-nums">{BILLING_BLOCKS.length} blocks</p>
      </header>
