                ...
                >
                  <div className="flex flex-wrap items-start justify-between gap-2">
                    ...
                    <span className="flex items-center gap-2">
                      ...
                      <ArrowUpRightIcon
                        aria-hidden="true"
                        className="size-3.5 text-muted-foreground opacity-0 transition-opacity duration-(--duration-moderate) group-hover:opacity-100 group-focus-visible:opacity-100"
                      />
                    </span>
                  </div>
