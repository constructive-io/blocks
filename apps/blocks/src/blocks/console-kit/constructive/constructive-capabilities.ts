...
const RULES: readonly CapabilityRule[] = [
  ...
  { capability: 'users.limits', endpoint: 'admin', operation: 'query', fields: ['appLimits'] },
  ...
  { capability: 'organizations.limits', endpoint: 'admin', operation: 'query', fields: ['orgLimits'] },
