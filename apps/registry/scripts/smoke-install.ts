...
const aiFiles = [
	...
	'model-selector.tsx',
	'plan-tracker.tsx',
	'prompt-input-attachment.tsx',
	'prompt-input-tray.tsx',
	'prompt-input.tsx',
...
`,
		...
		expected: [
			...
			'src/design-system/primitives/command.tsx',
			'src/design-system/primitives/kbd.tsx',
			'src/design-system/primitives/popover.tsx',
			'src/design-system/primitives/portal.tsx',
			'src/design-system/primitives/spinner.tsx',
			'src/design-system/primitives/tooltip.tsx',
			'src/shared/motion/fluid-highlight.tsx',
			'src/shared/motion/tuning.ts',
			'src/shared/slot.tsx',
			'src/shared/utils.ts',
		],
	...
	},
	{
		...
		expected: [
			...
			'src/components/ui/org-chart/org-chart-details.tsx',
			'src/components/ui/org-chart/org-chart-move-dialog.tsx',
			'src/components/ui/org-chart/org-chart-states.tsx',
	...
	},
	{
		name: 'agents-builder',
		expected: [
			'src/components/ui/agents-builder/agent-canvas.tsx',
			'src/components/ui/agents-builder/agent-run-panel.tsx',
			'src/components/ui/agents-builder/agent-view.tsx',
			'src/components/ui/agents-builder/agents-builder-context.tsx',
			'src/components/ui/agents-builder/agents-builder.tsx',
			'src/components/ui/agents-builder/app-picker.tsx',
			'src/components/ui/agents-builder/canvas-nodes.tsx',
			'src/components/ui/agents-builder/canvas-wires.tsx',
			'src/components/ui/agents-builder/chat-thread.tsx',
			'src/components/ui/agents-builder/chat-view.tsx',
			'src/components/ui/agents-builder/composer.tsx',
			'src/components/ui/agents-builder/connect-integration-dialog.tsx',
			'src/components/ui/agents-builder/demo-conversations.ts',
			'src/components/ui/agents-builder/demo-inbox.ts',
			'src/components/ui/agents-builder/demo-integrations.ts',
			'src/components/ui/agents-builder/demo-schedules.ts',
			'src/components/ui/agents-builder/fixtures.ts',
			'src/components/ui/agents-builder/index.ts',
			'src/components/ui/agents-builder/integration-mark.tsx',
			'src/components/ui/agents-builder/integration-sections.ts',
			'src/components/ui/agents-builder/inbox-view.tsx',
			'src/components/ui/agents-builder/integrations-view.tsx',
			'src/components/ui/agents-builder/mascot.tsx',
			'src/components/ui/agents-builder/playback.ts',
			'src/components/ui/agents-builder/reveal-text.tsx',
			'src/components/ui/agents-builder/schedules-view.tsx',
			'src/components/ui/agents-builder/sidebar.tsx',
			...
			'src/components/ui/workspace-kit/view-transition.tsx',
			'src/components/ui/ai/ask-card.tsx',
			'src/components/ui/ai/mark-tile.tsx',
			'src/components/ui/ai/tool-trace.tsx',
	...
	},
	{
		...
		expected: [
			'src/components/ui/billing-account/account-banner.tsx',
			'src/components/ui/billing-account/account-menu.tsx',
			'src/components/ui/billing-account/activity-view.tsx',
			'src/components/ui/billing-account/billing-account-context.tsx',
			'src/components/ui/billing-account/billing-account.tsx',
			'src/components/ui/billing-account/credits-view.tsx',
			'src/components/ui/billing-account/fixtures.ts',
			'src/components/ui/billing-account/index.ts',
			'src/components/ui/billing-account/invoices-view.tsx',
			'src/components/ui/billing-account/overview-view.tsx',
			'src/components/ui/billing-account/plans-view.tsx',
			'src/components/ui/billing-account/redemption.ts',
			'src/components/ui/billing-account/sidebar.tsx',
			'src/components/ui/billing-account/types.ts',
			'src/components/ui/billing-account/usage-view.tsx',
			'src/components/ui/billing-kit/allowance.tsx',
			'src/components/ui/billing-kit/catalog.tsx',
			'src/components/ui/billing-kit/code-admin.tsx',
			'src/components/ui/billing-kit/codes.tsx',
			'src/components/ui/billing-kit/context.tsx',
			'src/components/ui/billing-kit/credits.tsx',
			'src/components/ui/billing-kit/customers.tsx',
			'src/components/ui/billing-kit/demo.ts',
			'src/components/ui/billing-kit/entitlements.tsx',
			'src/components/ui/billing-kit/format.ts',
			'src/components/ui/billing-kit/index.ts',
			'src/components/ui/billing-kit/invoices.tsx',
			'src/components/ui/billing-kit/ledger.tsx',
			'src/components/ui/billing-kit/plan-change-dialog.tsx',
			'src/components/ui/billing-kit/plan.tsx',
			'src/components/ui/billing-kit/provider.tsx',
			'src/components/ui/billing-kit/providers.ts',
			'src/components/ui/billing-kit/standing.tsx',
			'src/components/ui/billing-kit/status.tsx',
			'src/components/ui/billing-kit/surface.tsx',
			'src/components/ui/billing-kit/types.ts',
			'src/components/ui/billing-kit/usage.tsx',
			'src/components/ui/workspace-kit/index.ts',
			'src/components/ui/workspace-kit/menu.tsx',
			'src/components/ui/workspace-kit/nav.tsx',
			'src/components/ui/workspace-kit/primitives.tsx',
			'src/components/ui/workspace-kit/reduced-motion.ts',
			'src/components/ui/workspace-kit/shell.tsx',
			'src/components/ui/workspace-kit/use-latest.ts',
			'src/components/ui/workspace-kit/view-transition.tsx',
			'src/components/ui/ai/text-shimmer.tsx',
	...
	},
	{
		...
		expected: [
			'src/components/ui/billing-console/billing-console-context.tsx',
			'src/components/ui/billing-console/billing-console.tsx',
			'src/components/ui/billing-console/catalog-view.tsx',
			'src/components/ui/billing-console/codes-tab.tsx',
			'src/components/ui/billing-console/customers-view.tsx',
			'src/components/ui/billing-console/fixtures.ts',
			'src/components/ui/billing-console/index.ts',
			'src/components/ui/billing-console/overview-view.tsx',
			'src/components/ui/billing-console/provider-view.tsx',
			'src/components/ui/billing-console/sidebar.tsx',
			'src/components/ui/billing-console/standing-view.tsx',
			'src/components/ui/billing-console/types.ts',
			'src/components/ui/billing-kit/allowance.tsx',
			'src/components/ui/billing-kit/catalog.tsx',
			'src/components/ui/billing-kit/code-admin.tsx',
			'src/components/ui/billing-kit/codes.tsx',
